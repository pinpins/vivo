...
UniValue getpeerinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "    \"subver\": \"/Vivo Core:x.x.x/\",  (string) The string version\n"
    ...
    BOOST_FOREACH(const CNodeStats& stats, vstats) {
        ...
        obj.push_back(Pair("lastblktime", stats.nLastBlockTime));
        obj.push_back(Pair("lasttxntime", stats.nLastTXTime));
...
UniValue getaddednodeinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "    \"addresses\" : [\n"
            "       {\n"
            "         \"address\" : \"192.168.0.201:9999\",  (string) The vivo server host and port\n"
...
UniValue getnetworkinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"subversion\": \"/Vivo Core:x.x.x/\",     (string) the server subversion string\n"
